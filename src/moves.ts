...
import { applyMove, moveHistory, King1Checked, King2Checked, playerTurn } from './board';
import * as Player from './Player';
import { getSkillLvl } from "./skillTree"
...
function checkLegalMovesKing(fromRow: number, fromCell: number, player: 1 | 2 | 0, board: Tile[][]): Position[] {
  ...
  if (getSkillLvl(playerTurn.value, "100") == 1) offsets.push([2, 0], [-2, 0], [0, 2], [0, -2], [2, 2], [2, -2], [-2, 2], [-2, -2]);
  for (const [rowOffset, cellOffset] of offsets) {
